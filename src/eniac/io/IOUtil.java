...
public class IOUtil {
	...
	public static List<Proxy> loadProxies(String path, int maxIndex, String text) {
	...
	public static void parse(InputStream in, DefaultHandler handler) throws IOException {
		try {
	...
	public static File getSettingsFile() {
		return new File(System.getProperty("user.home") //$NON-NLS-1$
				+ File.separator + EProperties.getInstance().getProperty("SETTINGS_FILE"));
	}
