...
public class OpenConfigurationPanel extends DialogPanel {
    ...
    public void init() {
        ...
        _textArea = new JTextArea(StringConverter.toInt(EProperties.getInstance()
                .getProperty("TEXT_AREA_ROWS")), StringConverter.toInt(EProperties
                .getInstance().getProperty("TEXT_AREA_COLUMNS")));
        ...
        _jpanel1.add(_listPane, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.5,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
                        0, 0, 0, 0), 0, 0));
        _jpanel1.add(_textPane, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.5,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
                        0, 0, 0, 0), 0, 0));

        // add jradiobutton1 and jpanel1
        add(_radioButton1, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
                        0, 0, 0, 0), 0, 0));
        add(_jpanel1, new GridBagConstraints(1, 0, 2, 1, 1.0, 1.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
                        0, 0, 0, 0), 0, 0));
        ...
        // add components
        _jpanel2.add(_jtextField, new GridBagConstraints(0, 0, 1, 1, 1.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(
                        0, 0, 0, 0), 0, 0));
        _jpanel2.add(fileChooserButton, new GridBagConstraints(1, 0, 1, 1, 0.0,
                0.0, GridBagConstraints.CENTER, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));

        // add jradiobutton2 and jpanel1
        add(_radioButton2, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(
                        0, 0, 0, 0), 0, 0));
        add(_jpanel2, new GridBagConstraints(1, 1, 2, 1, 1.0, 0.0,
        ...
        // layout components
        add(okButton, new GridBagConstraints(0, 2, 2, 1, 1.0, 0.0,
                GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                new Insets(0, 0, 0, 0), 0, 0));
        ...
        getActionMap().put("...", _fileChooserAction); //$NON-NLS-1$
        ...
        getInputMap(WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(
                ...
                Dictionary.CANCEL);
        getInputMap(WHEN_ANCESTOR_OF_FOCUSED_COMPONENT).put(
                KeyStroke.getKeyStroke('.'), "..."); //$NON-NLS-1$
        ...
        cancelButton.getInputMap(WHEN_FOCUSED)
                .put(KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0),
                        Dictionary.CANCEL);
        fileChooserButton.getInputMap(WHEN_FOCUSED).put(
                KeyStroke.getKeyStroke(KeyEvent.VK_ENTER, 0), "..."); //$NON-NLS-1$
    }
    ...
    public void performCancelAction() {
        _configurationType = NO_CONFIGURATION;
        SwingUtilities.windowForComponent(OpenConfigurationPanel.this)
                .dispose();
    }
    ...
    void performFilechooserAction() {
        ...
        if (returnVal == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                _jtextField.setText(chooser.getSelectedFile()
                        .getCanonicalPath());
                performUpdate();
